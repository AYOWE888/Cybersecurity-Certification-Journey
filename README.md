...
| :--- | :---: | :--- |
| 1.1 **Security Controls** | 🟢 | **Mastered** (Intermediate 100%) |
| 1.2 **Fundamental Security Concepts** | 🟡 | In Progress |
...
**Cisco Certificate of completion** [View CCNA] (CCNA/CCNA_Intro_to_networks_cert_of _completion.md)
